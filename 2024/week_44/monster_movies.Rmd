...
```{r}
font_add_google("Irish Grover","josefin sans")
showtext_auto()
```
...
```{r}
p <- ggplot(df, aes(x = genre1, y = average_rating,color = average_rating) )+
  geom_beeswarm(size = 1.5, cex = 0.6, alpha = 0.7) +
  coord_flip() +
  ...
  theme(legend.position = "none",
        ...
        axis.text.y = element_text(color = "#F3EDED", family = "josefin sans" , size = 20, face = "bold"),
        axis.text.x = element_text(color = "#F3EDED",family = "josefin sans",size = 20,face = "bold"),
...
```{r}
ggsave(path = "D:/TidyTuesday_2024/week_44",filename="p.png", plot=p, width=5, height=7)
```
...
p1 <- ggplot(df, aes(x = genre1, y = average_rating,color = title_type) )+
  ...
  theme(legend.position = "none",
        ...
        panel.grid.minor.x = element_blank(),
        axis.title.x = element_blank(),
        axis.text.y = element_text(color = "#e9ecef", family = "josefin sans" , size = 20, face = "bold"),
        axis.text.x = element_text(color = "#e9ecef",family = "josefin sans",size = 20,face = "bold"),
        plot.background = element_rect(fill = "black", color = "black"),
        plot.title.position = "plot",
  plot.title = element_textbox_simple(
      colour = "#e9ecef",
